...
exports.encriptedPassword = (password) => {
  let saltRound = 10;
  return bcrypt.genSalt(saltRound).then(salts => {
...
exports.comparePassword = (bdpassword, password) => {
  return bcrypt.compare(password, bdpassword).then(password => {
    return password
  }).catch(err => {
...
exports.validationPassword = async (string, validation, field, language, errorValidation) => {
...
exports.validationStringLenght = async (string, length, validation, field, language, errorValidation) => {
